...
if not Phase:
    ...
    if not Path('01.vcf/gt.impute.vcf.gz').is_file():
        print('now Phase')
        os.system('java -jar -Xmx20G /data/00/software/beagle/beagle.18May20.d20.jar gt=01.vcf/%s out=01.vcf/gt.impute nthreads=20'%(vcf_name))
        print('phase down')
...
def step1_sys(contig):
    ...
    #print(step1)
    #qualThreshold 即QUAL阈值,default=20
